...
export default function InvoiceTemp({ transaction, tempId }: InvoiceTempProps) {
    ...
    const handleDownloadPDF = async () => {
        try {
            ...
            if (response.ok) {
                ...
                a.href = url;
                a.download = `Invoice-${transaction.order_id}.pdf`;
    ...
    if (isLoading) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-100 dark:from-orange-900/20 dark:to-amber-900/20 flex items-center justify-center">
            ...
            <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-100 dark:from-orange-900/20 dark:via-amber-900/20 dark:to-yellow-900/20">
                    ...
                    <div className="max-w-4xl mx-auto px-6 py-5">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                                <div className="w-14 h-14 rounded-2xl overflow-hidden shadow-xl ring-4 ring-blue-100/50 dark:ring-gray-700/50">
                                    <img
                                        src={getLogoUrl()}
                                        alt="Haji Logo"
                            ...
                            <button
                                ...
                                className="group flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 text-white rounded-2xl transition-all duration-300 font-bold shadow-2xl hover:shadow-3xl transform hover:-translate-y-1 hover:scale-105"
                            >
                ...
                <div className="max-w-4xl mx-auto px-6 py-8">
                    <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
                        ...
                        <div className="relative bg-gradient-to-r from-orange-600 via-amber-600 to-yellow-600 px-8 py-8 text-white overflow-hidden">
                            ...
                            <div className="relative flex justify-between items-center">
                                <div>
                                    ...
                                    <p className="text-orange-100 text-lg font-medium">Professional Printing Services</p>
                                </div>
                                <div className="text-right">
                                    <h3 className="text-2xl font-bold mb-1">Invoice</h3>
                                    <p className="text-orange-100 text-lg font-medium">{transaction.order_id}</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="pl-13 space-y-2">
                                        ...
                                        <p className="text-gray-700 dark:text-gray-300 text-sm">
                                            ...
                                            <span className={`ml-2 px-3 py-1 rounded-full text-xs font-bold ${
                                                ...
                                                transaction.status === 'debt' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200' :
                        ...
                        <div className="px-8 py-6">
                            ...
                            <div className="space-y-4">
                                {transaction.items.map((item, index) => (
                                    <div key={index} className="group bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-700 dark:to-gray-600 rounded-2xl p-6 border border-gray-200/50 dark:border-gray-600/50 hover:shadow-lg transition-all duration-300">
                        ...
                        {/* Modern Totals */}
                        <div className="px-8 py-6 bg-gradient-to-r from-gray-50 via-blue-50 to-indigo-50 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700 border-t border-gray-200/50 dark:border-gray-600/50">
                        ...
                        {/* Modern Footer */}
                        <div className="px-8 py-6 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white text-center">
                            <div className="space-y-3">
                                <p className="text-lg font-bold">
                                    🎉 Thank you for choosing Haji Printing!
                                </p>
