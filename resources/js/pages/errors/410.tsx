...
export default function Error410({ message = "This link has expired", expired_at }: Error410Props) {
    return (
        <>
            <Head title="410 - Link Expired" />
                    ...
                    {expired_at && (
                        <div className="mb-8 p-4 bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg">
                            <p className="text-sm text-gray-700 dark:text-gray-300">
                                <strong>Expired on:</strong> {new Date(expired_at).toLocaleString()}
                            </p>
                        </div>
                    )}
