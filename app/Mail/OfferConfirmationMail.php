...
class OfferConfirmationMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Price Offer - Haji Printing',
        );
    }
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'emails.offer-confirmation',
            with: [
    ...
    public function attachments(): array
    {
        try {
            ...
            \Illuminate\Support\Facades\Log::info('Starting PDF generation for offer email attachment', [
            ...
            \Illuminate\Support\Facades\Log::info('Offer invoice HTML received for PDF', [
            ...
            \Illuminate\Support\Facades\Log::info('Offer invoice HTML after cleaning', [
            ...
            // Create filename
            $filename = 'Offer-' . ($this->orderData['order_id'] ?? time()) . '.pdf';
            ...
            \Illuminate\Support\Facades\Log::info('Offer PDF attachment created successfully', [
                'order_id' => $this->orderData['order_id'] ?? 'unknown',
                'filename' => $filename,
            ...
            \Illuminate\Support\Facades\Log::error('PDF generation failed for offer email attachment', [
                'order_id' => $this->orderData['order_id'] ?? 'unknown',
                'customer_name' => $this->orderData['customer_name'] ?? 'unknown',
